...
function Sidebar(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
  {['Dashboard', 'Assignments', 'Research', 'My Results', 'My Team'].map((text, index) => (
    <ListItem key={text} disablePadding>
      <ListItemButton
        component={Link}
        to={text === 'Dashboard' ? '/studentDash' : 
        text === 'Assignments' ? '/assignments' : 
        text === 'Research' ? '/research' : 
        text === 'My Results' ? '/myResults' : 
        text === 'My Team' ? '/myTeam' : `/${text.toLowerCase().replace(/\s/g, '-')}`}
      >
