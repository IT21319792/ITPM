      ...
      <div className="container max-w-lg px-4 py-32 text-center">
        ...
        <div className=" items-center mt-12 mx-6 text-center gap-5">
          ...
          <span className="relative inline-flex mx-6 w-full md:w-auto">
            <a href="studentlogin" className="inline-flex items-center justify-center w-full px-8 py-4 text-base font-bold leading-6 text-white bg-indigo-600 border border-transparent rounded-full md:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
              Student Login
        ...
        <div className=" items-center mt-12 mx-6 text-center gap-5">
          ...
          <span className="relative inline-flex mx-6 w-full md:w-auto">
            <a href="adminlogin" className="inline-flex items-center justify-center w-full px-8 py-4 text-base font-bold leading-6 text-white bg-indigo-600 border border-transparent rounded-full md:w-auto hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
              Admin Login
            </a>{/* same login page eka */}
          </span>
