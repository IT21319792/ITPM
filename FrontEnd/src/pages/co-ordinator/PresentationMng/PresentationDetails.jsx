              ...
              <tr key={schedule._id} className="hover:bg-gray-100">
                ...
                <td className="p-2 border border-gray-300">
                  <button onClick={() => handleUpdateClick(schedule)} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-3 rounded focus:outline-none focus:shadow-outline">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 4v7a4 4 0 01-4 4H4" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 20h8" /></svg>
                  </button>
                </td>
              </tr>
            ))}
