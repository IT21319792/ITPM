...
function ExaminerPresentationMarks({ rowData }) {
  ...
  useEffect(() => {
    ...
    // Set initial values based on rowData
    if (rowData) {
  ...
  const handleSubmit = async (e) => {
    ...
    for (let i = 1; i <= criteriaCount; i++) {
      ...
      const mark = markInput ? markInput.value : ''; // Check if markInput exists before accessing its value
              ...
              <div className="w-full md:w-1/2 px-3">
                ...
                <div className="relative">
                  <input
                    ...
                    id="group"
                    placeholder={rowData1 ? rowData1.GroupID : ''}
                    value={selectedGroup}
